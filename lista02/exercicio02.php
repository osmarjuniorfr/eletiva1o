...
<body>
    <div class="container py-3">
        ...
        <form method="post">
            ...
            <div class="mb-3">
                <label for="numero2" class="form-label">Informe um outro número: </label>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($n1 == $n2) {
        $resultado = ($n1 + $n2) * 3;
        echo "<h2>O triplo da soma dos números é $resultado</h2>";
    } else {
        $resultado = $n1 + $n2;
        echo "<h2>A soma dos números é $resultado</h2>";
    }
}
